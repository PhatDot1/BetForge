...
contract ArbitrumNFTMinterX101 is ERC721Enumerable, Ownable {
    using Strings for uint256;

    // Variables
    uint256 public mintPrice = 0.0001 ether; // Cheaper mint price for Arbitrum
    ...
    constructor() ERC721("ArbitrumNFT", "ARBFT") Ownable(msg.sender) {}
